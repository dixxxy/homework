...
class Crawler(object):
    ...
    def __init__(self,name,stay_url):
        """
        初始化
        :param name:
        :param stay_url:
        ...
        self.domain = '{url.scheme}://{url.netloc}'.format(url=urlparse(self.start_url))
...
if __name__ == '__main__':
    ...
    crawler = htmltopdf("廖雪峰Python", start_url)
    crawler.run()
